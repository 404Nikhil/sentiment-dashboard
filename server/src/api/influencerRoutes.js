...
// const { analyzeImage } = require('../services/aiAnalyzer'); // Temporarily unused
...
router.get('/:username', async (req, res) => {
  ...
  try {
    ...
    //   })
    // );
    // // For now, we will use the posts directly from the scraper.
    // const enrichedPosts = scrapedData.recentPosts;
    ...
    console.log(`Successfully scraped and sent data for ${username}`);
    res.json(influencer);
